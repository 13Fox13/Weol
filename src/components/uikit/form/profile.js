    ...
    return (
      <View style={{flex: 1}}>
        ...
        <ScrollView style={styles.container}>
          <Image source={require('../../../../res/images/profile.jpg')} resizeMode="stretch" style={{height: 350, width}} />
          <View style={[styles.row, {marginTop: 15}]}>
            <Text style={{fontSize: 19, fontWeight: '400'}}>Андрей, </Text><Text style={{fontSize: 21, fontWeight: '300', marginBottom: -2}}>23</Text>
          </View>
      ...
      Фото из Instagram
            ...
            >
              <View style={{}}>
                <Image source={require('../../../../res/images/profile.jpg')} resizeMode="stretch" style={{height: 100, width: 100, margin: 5}} />
                <Image source={require('../../../../res/images/profile.jpg')} resizeMode="stretch" style={{height: 100, width: 100, margin: 5}} />
              </View>
              <View style={{}}>
                <Image source={require('../../../../res/images/profile.jpg')} resizeMode="stretch" style={{height: 100, width: 100, margin: 5}} />
